...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void changeDetailsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeDetailsMenuItemActionPerformed
        defaultSelection(jLabel3,jLabel4,jLabel5,jLabel6,jLabel7,salesReportLab,userLab);
    ...
    private void salesReportBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_salesReportBttnMouseClicked
        highlightSelection(salesReportLab);
        addSalesReportPage();
    }//GEN-LAST:event_salesReportBttnMouseClicked

    private void highlightSelection(javax.swing.JLabel jLabel){
       defaultSelection(jLabel3,jLabel4,jLabel5,jLabel6,jLabel7,salesReportLab,userLab);
        jLabel.setOpaque(true);
        jLabel.setForeground(new java.awt.Color(242, 242, 242));
        jLabel.setBackground(new java.awt.Color(0, 102, 204));
    }
    
    private void defaultSelection(javax.swing.JLabel... jLabels) {
        for(javax.swing.JLabel jLabel:jLabels){
