...
//    addPurchaseDAO
    ...
    */
    ...
    public ResultSet getQueryResult() {
        try {
            String query = "SELECT productcode AS \"Product Code\",productname AS \"Product Name\",costprice AS \"Cost Price\",sellingprice AS \"Selling Price\",brand AS Brand FROM products ORDER BY pid";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public ResultSet getPurchaseResult() {
        try {
            String query = "SELECT purchaseid AS \"Purchase ID\",purchaseinfo.productcode AS \"Purchase Code\",productname AS \"Product Name\",quantity AS \"Quantity\",totalcost AS \"Total Cost\" FROM purchaseinfo INNER JOIN products ON products.productcode=purchaseinfo.productcode ORDER BY purchaseid";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public ResultSet getQueryResultOfCurrentStocks() {
        try {
            String query = "SELECT currentstocks.productcode AS \"Product Code\",products.productname AS \"Product Name\",currentstocks.quantity AS \"Quantity\",products.costprice AS \"Cost Price\",products.sellingprice AS \"Selling Price\"FROM currentstocks INNER JOIN products ON currentstocks.productcode=products.productcode";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public ResultSet getSalesReportQueryResult() {
        try {
            String query = "SELECT salesid AS SalesId , salesreport.productcode AS \"Product Code\",productname AS \"Product Name\",salesreport.quantity AS \"Quantity\",revenue AS \"Revenue\",soldby AS \"Sold By\" FROM salesreport INNER JOIN products ON salesreport.productcode=products.productcode";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
     ...
     public ResultSet getSearchProductsQueryResult(String searchTxt) {
        try {
            String query = "SELECT pid AS \"PID\",productcode AS \"Product Code\",productname AS \"Product Name\",costprice AS \"Cost Price\",sellingprice AS \"Selling Price\",brand AS \"Brand\" FROM products WHERE productname LIKE '%"+searchTxt+"%' OR brand LIKE '%"+searchTxt+"%' OR productcode LIKE '%"+searchTxt+"%'";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
     ...
     public ResultSet getSearchPurchaseQueryResult(String searchTxt) {
        try {
            String query = "SELECT purchaseid AS \"Purchase Id\",purchaseinfo.productcode AS \"Product Code\",productname AS \"Product Name\",quantity AS \"Quantity\",totalcost AS \"Total Cost\" FROM purchaseinfo INNER JOIN products ON products.productcode=purchaseinfo.productcode WHERE purchaseinfo.productcode LIKE '%"+searchTxt+"%' OR productname LIKE '%"+searchTxt+"%' ORDER BY purchaseid";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
   ...
   public ResultSet getSearchSalesQueryResult(String searchTxt) {
        try {
            String query = "SELECT salesid AS \"Sales Id\",salesreport.productcode AS \"Product Code\",productname AS \"Product Name\",quantity AS \"Quantity\",revenue AS \"Revenue\",soldby AS \"Sold By\" FROM salesreport INNER JOIN products ON products.productcode=salesreport.productcode INNER JOIN customers ON customers.customercode=salesreport.customercode WHERE salesreport.productcode LIKE '%"+searchTxt+"%' OR productname LIKE '%"+searchTxt+"%' OR soldby LIKE '%"+searchTxt+"%' OR fullname LIKE '%"+searchTxt+"%' ORDER BY salesid";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
